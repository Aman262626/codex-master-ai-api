...
# Version: 3.1.0 - Bug Fixes (Python 3.9 compat + key cycle)
# Deploy: Render
# ============================================================
...
app = FastAPI(
    ...
    description="""🚀 Master AI API v3.1
...
# GOOGLE_API_KEY=AIza_key1,AIza_key2
# ============================================================
...
# FIX: Use itertools.cycle always (iter([""]) is NOT infinite)
_or_cycle   = itertools.cycle(_OR_KEYS   if _OR_KEYS   else [""])
_groq_cycle = itertools.cycle(_GROQ_KEYS if _GROQ_KEYS else [""])
_ggl_cycle  = itertools.cycle(_GGL_KEYS  if _GGL_KEYS  else [""])
...
# /tmp is writable on Render free tier
# ============================================================
DB_PATH = "/tmp/api_keys.db"
...
MODELS: Dict[str, Dict[str, Any]] = {
    ...
    "llama-3.3-70b": {
        ...
        "context_window": 131072, "multimodal": False,
        "best_for": ["general", "coding", "analysis", "writing", "chat"],
        "speed": "fast", "developer": "Meta",
        "description": "Meta Llama 3.3 70B - Best free general model. 128K ctx, multilingual."
    },
    "gemini-2.0-flash-free": {
        "id": "google/gemini-2.0-flash-exp:free",
        "provider": "openrouter", "tier": "free",
        "context_window": 1048576, "multimodal": True,
        "best_for": ["multimodal", "vision", "long-context", "general"],
        "speed": "very-fast", "developer": "Google",
        "description": "Gemini 2.0 Flash free via OpenRouter - 1M ctx, vision."
    },
    "deepseek-r1-free": {
        "id": "deepseek/deepseek-r1:free",
        "provider": "openrouter", "tier": "free",
        "context_window": 163840, "multimodal": False,
        "best_for": ["math", "reasoning", "science", "logic"],
        "speed": "medium", "developer": "DeepSeek",
        "description": "DeepSeek R1 - Chain-of-thought. Best for math/science/logic."
    },
    "qwen-2.5-72b-free": {
    ...
    "mistral-7b-free": {
        ...
        "provider": "openrouter", "tier": "free",
        "context_window": 32768, "multimodal": False,
        "best_for": ["quick-tasks", "writing", "lightweight"],
        "speed": "fast", "developer": "Mistral AI",
        "description": "Mistral 7B - Lightweight and fast."
    },
    "phi-3-mini-free": {
        "id": "microsoft/phi-3-mini-128k-instruct:free",
        "provider": "openrouter", "tier": "free",
        "context_window": 128000, "multimodal": False,
        "best_for": ["lightweight", "simple-tasks"],
        "speed": "ultra-fast", "developer": "Microsoft",
        "description": "Phi-3 Mini - 128K ctx. Ultra lightweight."
    },
    ...
    "llama-groq-fast": {
        ...
        "context_window": 128000, "multimodal": False,
        "best_for": ["speed", "real-time", "chat"],
        "speed": "ultra-fast (~1200 tok/s)", "developer": "Meta + Groq",
        "description": "Llama 3.3 on Groq LPU - FASTEST. ~1200 tok/s."
    },
    "mixtral-groq-fast": {
        "id": "mixtral-8x7b-32768",
        "provider": "groq", "tier": "free",
        "context_window": 32768, "multimodal": False,
        "best_for": ["speed", "general"],
    ...
    "gemma2-groq": {
        "id": "gemma2-9b-it",
        "provider": "groq", "tier": "free",
        "context_window": 8192, "multimodal": False,
        "best_for": ["lightweight", "quick-chat"],
        "speed": "ultra-fast", "developer": "Google + Groq",
        "description": "Gemma 2 9B on Groq - Ultra-fast lightweight."
    },
    ...
    "gemini-2.0-flash": {
        ...
        "context_window": 1048576, "multimodal": True,
        "best_for": ["vision", "multimodal", "long-context", "general"],
        "speed": "fast", "developer": "Google",
        "description": "Gemini 2.0 Flash - Google AI Studio. 1M ctx, vision/audio/video."
    },
    "gemini-1.5-pro": {
        "id": "gemini-1.5-pro",
        "provider": "google", "tier": "free",
        "context_window": 2097152, "multimodal": True,
    ...
    "claude-opus-4": {
        ...
        "context_window": 200000, "multimodal": True,
        "best_for": ["complex-reasoning", "research", "creative"],
        "speed": "slow", "developer": "Anthropic",
        "description": "Claude Opus 4 - Most powerful, extended thinking."
    },
    "claude-sonnet-4": {
    ...
    "gpt-4o": {
        "id": "openai/gpt-4o",
        "provider": "openrouter", "tier": "premium",
        "context_window": 128000, "multimodal": True,
        "best_for": ["vision", "json", "function-calling"],
        "speed": "fast", "developer": "OpenAI",
        "description": "GPT-4o - Vision, JSON mode, function calling."
    },
    "o3-mini": {
        "id": "openai/o3-mini",
        "provider": "openrouter", "tier": "premium",
        "context_window": 200000, "multimodal": False,
        "best_for": ["math", "science", "STEM"],
        "speed": "medium", "developer": "OpenAI",
        "description": "o3-mini - Extended thinking. Best for STEM."
    },
    "gemini-2.5-pro": {
        "id": "google/gemini-2.5-pro-preview",
        "provider": "openrouter", "tier": "premium",
        "context_window": 2097152, "multimodal": True,
        "best_for": ["2M-context", "video"],
        "speed": "medium", "developer": "Google",
        "description": "Gemini 2.5 Pro - 2M ctx, extended thinking, video."
    },
    "perplexity-sonar-pro": {
        "id": "perplexity/sonar-pro",
        "provider": "openrouter", "tier": "premium",
        "context_window": 127072, "multimodal": False,
        "best_for": ["web-search", "real-time", "news"],
    ...
    "codestral-2501": {
        ...
        "provider": "openrouter", "tier": "premium",
        "context_window": 256000, "multimodal": False,
        "best_for": ["code-generation", "FIM", "debugging"],
        "speed": "fast", "developer": "Mistral AI",
        "description": "Codestral 2501 - Dedicated code model. FIM, 256K ctx."
    },
    "deepseek-v3": {
    ...
    "nova-pro": {
        ...
        "provider": "openrouter", "tier": "premium",
        "context_window": 300000, "multimodal": True,
        "best_for": ["document-analysis", "enterprise"],
        "speed": "fast", "developer": "Amazon",
        "description": "Amazon Nova Pro - 300K ctx, enterprise-grade."
    },
}
...
def intelligent_route(prompt: str, task_type: str = "auto", prefer_free: bool = True) -> str:
    ...
    signals: Dict[str, List[str]] = {
        "code":      ["code","program","function","debug","html","css","javascript",
                      "python","api","fix","error","build","website","react","sql","deploy"],
    ...
    detected: Dict[str, int] = {
        k: sum(1 for w in v if w in p)
        for k, v in signals.items() if any(w in p for w in v)
    }
    if task_type != "auto":
...
# FIX: No mutable default dict argument
async def _call_openai_style(
    url: str, key: str, model_id: str,
...
async def _stream_openrouter(
    model_id: str, key: str, messages: list, max_tokens: int, temperature: float
    ...
    async with httpx.AsyncClient(timeout=120.0) as c:
        async with c.stream("POST", OR_URL, json=payload, headers=h) as r:
...
# FIX: tuple[dict, str] -> Tuple[dict, str] for Python 3.9 compatibility
async def call_provider_with_fallback(
    ...
    On 429/5xx -> auto switches to next model in fallback chain.
    Returns (result_dict, actual_model_alias_used)
    """
    ...
    for model_alias in chain:
        try:
            ...
            last_error = e
            continue
    raise HTTPException(503, f"All providers failed. Last error: {str(last_error)}")
...
async def root() -> HTMLResponse:
    ...
    <div class="hero">
      ...
      <div class="sub">v3.1 &mdash; Multi-Key Rotation &middot; Auto Fallback &middot; {len(MODELS)} Models</div>
      <div style="margin-top:14px">
        <span class="badge free">Key Rotation ON</span>
        <span class="badge hot">Auto Fallback ON</span>
        <span class="badge blue">{len(MODELS)} Models</span>
        <span class="badge free">Multimodal</span>
      </div>
    </div>
    <div class="stats">
    ...
    <div class="grid">
      ...
      <div class="card"><h3>POST /build-html</h3><p>Build production HTML projects (Lovable-style).</p></div>
      <div class="card"><h3>POST /analyze-image</h3><p>Analyze images with Gemini multimodal.</p></div>
...
async def health() -> dict:
    return {
        ...
        "features": {"key_rotation": True, "auto_fallback": True},
...
async def key_stats() -> dict:
    return {
        ...
        "tip": "Add more keys as comma-separated: OPENROUTER_API_KEY=key1,key2,key3"
    }
...
@app.post("/chat")
async def chat(req: ChatRequest, _k: str = Depends(get_api_key)) -> dict:
    if not req.messages:
    ...
    if alias == "auto":
        ...
        if isinstance(last, str):
            ...
            last_text = " ".join(
                p.get("text", "") for p in last
                if isinstance(p, dict) and p.get("type") == "text"
            )
        alias = intelligent_route(last_text, req.task_type or "auto", bool(req.prefer_free))
        routed = True
    ...
    if req.stream and MODELS[alias]["provider"] == "openrouter":
        ...
        return StreamingResponse(
            _stream_openrouter(MODELS[alias]["id"], key, msgs, req.max_tokens or 4096, req.temperature or 0.7),
            media_type="text/event-stream"
        )

    result, used_alias = await call_provider_with_fallback(alias, msgs, req.max_tokens or 4096, req.temperature or 0.7)
    return {
        "success": True,
...
async def openai_compat(body: Dict[str, Any], _k: str = Depends(get_api_key)) -> Any:
    req = ChatRequest(
...
@app.post("/build-html")
async def build_html(req: HTMLBuilderRequest, _k: str = Depends(get_api_key)) -> dict:
    styles: Dict[str, str] = {
    ...
    system = (
        ...
        "ALL CSS in <style>, ALL JS in <script>. No placeholders, every interaction must work, "
        "mobile-responsive, production-ready."
    )
    style_val = req.style if req.style else "modern"
    user = (
        f"Build a complete {req.project_type}: {req.prompt}\n"
        f"Style: {styles.get(style_val, styles['modern'])}\n"
        f"{'Rich animations, CSS keyframes.' if req.include_animations else 'Minimal animations.'}\n"
        f"{'Fully responsive mobile-first.' if req.responsive else 'Desktop only.'}"
    )
    pref = req.preferred_model
    alias = pref if (pref and pref != "auto" and pref in MODELS) else "qwen-2.5-72b-free"
    msgs: List[Dict[str, Any]] = [
...
async def analyze_image(
    ...
    alias = m if (m in MODELS and MODELS[m].get("multimodal")) else "gemini-2.0-flash"
    result, used = await call_provider_with_fallback(
        alias, [{"role": "user", "content": content}], 2048, 0.4
    )
    return {"analysis": result["choices"][0]["message"]["content"], "model_used": used}

@app.post("/route-test")
async def route_test(body: Dict[str, Any]) -> dict:
    prompt      = str(body.get("prompt", ""))
    task_type   = str(body.get("task_type", "auto"))
...
async def generate_key(req: APIKeyRequest) -> dict:
    k = "cx-" + secrets.token_urlsafe(32)
    conn = sqlite3.connect(DB_PATH)
    conn.execute(
        "INSERT INTO api_keys(key,name,email,created_at,tier) VALUES(?,?,?,?,?)",
        (k, req.name, req.email or "", datetime.now().isoformat(), req.tier or "free")
    )
    conn.commit()
    conn.close()
    return {
        "api_key": k, "name": req.name, "tier": req.tier,
        "header": "X-API-Key", "note": "Set REQUIRE_AUTH=true to enforce auth"
    }

@app.get("/key-info/{api_key}")
async def key_info(api_key: str) -> dict:
    conn = sqlite3.connect(DB_PATH)
    c = conn.cursor()
    c.execute(
